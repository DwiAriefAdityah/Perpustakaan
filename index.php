<!-- https://www.youtube.com/watch?v=Smx-gmVzaSE&list=PLyKwc9t6O-eenKbG4fC6HP60Widj7LueZ -->
<?php
    include "fungsi_php/config.php";

    include "fungsi_php/function.php";
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="index.php"><i class="fa fa-dashboard fa-3x"></i> Dashbord</a>
                    </li>
                    <li>
                        <a  href="?page=buku"><i class="fa fa-book fa-3x"></i> Data buku</a>
                    </li>
                     <li>
                        <a  href="?page=anggota"><i class="fa fa-dashboard fa-3x"></i> Anggota</a>
                    </li>
                     <li>
